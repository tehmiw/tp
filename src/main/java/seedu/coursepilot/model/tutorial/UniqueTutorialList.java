 ...
 * As such, adding and updating of tutorials uses Tutorial#isSameTutorial(Tutorial) for equality so as to ensure
 * that the tutorial being added or updated is unique in terms of identity in the UniqueTutorialList.
